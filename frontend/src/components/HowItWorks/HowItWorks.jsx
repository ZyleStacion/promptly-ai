...
const HowItWorksMenu = [
  ...
  },
  {
    ...
    description:
      "Upload documents, files, and data about your business to train the model.",
    icon: <FcUpload className="text-6xl p-2" />,
    delay: 0.6,
  },
  {
    id: 3,
    ...
    description:
      "Get your trained AI model and deploy it locally in your infrastructure.",
    icon: <FcDownload className="text-6xl p-2" />,
    delay: 0.9,
  },
];
