        ...
        >
          ...
          >
            ...
            <p className="text-gray-400 text-sm mb-6">
              Update settings, training data and avatar.
            </p>
              ...
              <div className="bg-neutral-900 rounded-lg p-4 border border-gray-700 flex flex-col">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      className="px-3 py-2 bg-neutral-800 rounded border border-gray-600 hover:bg-neutral-700 text-sm"
                ...
                <div className="space-y-2 overflow-y-auto">
                  ...
                  {editingTrainingData.map((data, idx) => (
                    <div
                      key={idx}
                      className="flex items-center justify-between bg-neutral-800 p-3 rounded border border-gray-600"
                    >
                      ...
                      <button
                        onClick={() => onRemoveTrainingItem(idx)}
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                onClick={onSave}
                disabled={saving || !chatbotName.trim()}
