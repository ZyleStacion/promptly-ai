...
const WhyChooseOurPlatformMenu =[
  {
    id: 1,
    title: 'Privacy First',
    description: 'Your data stays yours. Train locally and keep full control of your AI model.',
  ...
  },
{
    id: 3,
    title: 'Easy to Use',
    description: 'No technical expertise required. Simple chat interface and automated training.',
        ...
        <div className=' flex flex-col mt-5 xl:pt-24 md:pt-24 px-8 pb-10 md:pr-10 xl:pr-30 '>
            <div className=' text-center md:text-left space-y-6'>
                ...
                transition={{duration: 0.4}}
                 className='  text-5xl font-semibold  bg-gradient-to-r from-blue-600 to-violet-600 text-transparent bg-clip-text'>Why Choose Our Platform ?</motion.h1>
